...
class MaintenanceCommand : CustomCommand("manutenção"), GroupCommandRestrictable {
    ...
    override fun onCommand(
        ...
        val currentState = CoreProvider.Repositories.PostgreSQL.MAINTENANCE_REPOSITORY.provide().fetchByApplication(application)
        ...
        CoreProvider.Repositories.PostgreSQL.MAINTENANCE_REPOSITORY.provide().update(
            application,
            newState
        )
